...
static sgx_status_t SGX_CDECL sgx_cnn_inference_f32_cpp(void* pms)
{
	CHECK_REF_POINTER(pms, sizeof(ms_cnn_inference_f32_cpp_t));
	//
	// fence after pointer checks
	//
	sgx_lfence();
	ms_cnn_inference_f32_cpp_t* ms = SGX_CAST(ms_cnn_inference_f32_cpp_t*, pms);
	sgx_status_t status = SGX_SUCCESS;



	ms->ms_retval = cnn_inference_f32_cpp();


	return status;
}

static sgx_status_t SGX_CDECL sgx_cnn_training_f32_cpp(void* pms)
{
	CHECK_REF_POINTER(pms, sizeof(ms_cnn_training_f32_cpp_t));
	//
	// fence after pointer checks
	//
	sgx_lfence();
	ms_cnn_training_f32_cpp_t* ms = SGX_CAST(ms_cnn_training_f32_cpp_t*, pms);
	sgx_status_t status = SGX_SUCCESS;



	ms->ms_retval = cnn_training_f32_cpp();
...
SGX_EXTERNC const struct {
	...
	2,
	{
		{(void*)(uintptr_t)sgx_cnn_inference_f32_cpp, 0, 0},
		{(void*)(uintptr_t)sgx_cnn_training_f32_cpp, 0, 0},
	}
};
